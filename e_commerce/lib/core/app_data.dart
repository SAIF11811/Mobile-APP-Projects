...
import 'package:e_commerce/src/model/bottom_nav_bar_item.dart';
...
class AppData {
  ...
  static List<RecommendedProduct> recommendedProducts = [
    RecommendedProduct(
      imagePath: 'assets/images/apple_watch_series_7_1.png',
      cardBackgroundColor: const Color(0xFFEC6813),
    ),
    RecommendedProduct(
      imagePath: 'assets/images/beats_studio_3-1.png',
